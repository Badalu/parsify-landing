      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="brutal-card p-5 md:p-12 bg-card relative">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight leading-none mb-10 text-shadow-color uppercase font-sans">
            Bank Statement <span className="text-secondary bg-secondary/10 px-2 border-2 border-secondary inline-block transform -rotate-1 mt-2 md:mt-0">Reconciliation Process</span> in Tally
          </h1>
