...
export const metadata: Metadata = {
  title: 'Union Bank Bank Statement to Excel Converter — PDF to Excel/CSV Free | Parsify',
  description:
    'Convert Union Bank bank statement PDF to Excel or CSV instantly. Supports all Union Bank statement formats — savings, current, credit card, fixed deposit. Auto GST tagging, Tally-ready output. Free for Indian CAs.',
  alternates: {
    canonical: 'https://parsify.in/union-bank-bank-statement-converter',
  },
  openGraph: {
    title: 'Union Bank Bank Statement to Excel Converter — Free | Parsify',
    description: 'Convert Union Bank bank statement PDF to clean Excel/CSV in seconds. Auto-detects all Union Bank formats. Used by 2,400+ CA firms across India.',
    url: 'https://parsify.in/union-bank-bank-statement-converter',
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How to convert Union Bank bank statement PDF to Excel?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Go to Parsify.in, upload your Union Bank bank statement PDF, and download a clean Excel file in seconds. Parsify auto-detects all Union Bank statement formats including savings, current, and credit card statements."
      }
    },
    {
      "@type": "Question",
      "name": "Does Parsify support Union Bank NetBanking downloaded statements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Parsify supports all Union Bank statement formats — statements downloaded from Union Bank NetBanking, Union Bank mobile app, and even scanned/physical copies. Both portrait and landscape layouts are handled automatically."
      }
    },
    {
      "@type": "Question",
      "name": "Can I convert password-protected Union Bank bank statements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Just upload the PDF and enter the password when prompted. Parsify handles Union Bank's standard password format (usually your customer ID or date of birth) and extracts all transactions accurately."
      }
    },
    {
      "@type": "Question",
      "name": "Is the Union Bank statement converter free?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can convert 1 Union Bank statement per day completely free without signing up. Create a free account for 50 free pages monthly. Paid plans start at ₹999/month for 40 statements."
      }
    }
  ]
};
...
const BANK_FORMATS = [
  ...
  { name: 'Union Bank Fixed Deposit', desc: 'FD statements with interest accrual and maturity details' },
  { name: 'Union Bank Demat/Trading', desc: 'Demat account statements with stock transaction details' },
  { name: 'Union Bank NRI Account', desc: 'NRE/NRO account statements with forex conversion details' },
];

export default function UnionBankConverterPage() {
  return (
    <main className="bg-background min-h-screen text-foreground selection:bg-primary selection:text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              <div className="inline-block border-2 border-shadow-color bg-card px-3 py-1 text-sm font-bold uppercase tracking-widest text-primary mb-8 brutal-shadow">
                Union Bank Bank Statement Converter
              </div>
              ...
              <p className="text-lg text-muted-foreground font-medium mb-10 max-w-lg leading-relaxed">
                Upload your Union Bank bank statement PDF — savings, current, or credit card. Get a clean, structured Excel or CSV file in under 5 seconds. Auto GST tagging and Tally-ready output included.
              </p>
      ...
      <section className="border-b-2 border-shadow-color bg-card">
        <div className="max-w-7xl mx-auto flex flex-wrap lg:grid lg:grid-cols-4 divide-y-2 lg:divide-y-0 lg:divide-x-2 divide-shadow-color">
          {[
            ...
            { num: '99.3%', label: 'Accuracy on Union Bank' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              All Union Bank <span className="text-primary bg-primary/10 px-2 border-2 border-primary inline-block mt-2 sm:mt-0">Formats Supported</span>
            </h2>
            <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
              Parsify auto-detects every Union Bank statement layout. No manual template selection needed — just upload and download.
            </p>
          </div>
      ...
      <section className="py-24 border-b-2 border-shadow-color bg-card bg-grid-pattern">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              Convert Union Bank Statement <span className="text-secondary inline-block mt-2 sm:mt-0">in 3 Steps</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                num: '01',
                title: 'Upload Union Bank PDF',
                desc: 'Drag and drop your Union Bank bank statement. Password-protected PDFs are handled automatically. Works with NetBanking, mobile app, and branch downloads.',
                icon: FileText,
              },
              {
                num: '02',
                title: 'AI Parses Everything',
                desc: 'Our engine reads every transaction row, resolves Union Bank\'s merged cells and multi-page formatting, auto-tags GST, extracts party names, and categorizes transactions.',
                icon: Zap,
              },
              {
                num: '03',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-6 leading-tight">
                Why CAs Choose Parsify for <span className="bg-secondary text-white px-2 border-2 border-shadow-color inline-block rotate-1 mt-2 lg:mt-0">Union Bank Statements</span>
              </h2>
              <p className="text-lg text-muted-foreground font-medium mb-10">
                Union Bank Bank statements are notoriously difficult to parse — merged header rows, inconsistent date formats, multi-page transaction tables that break mid-row. Parsify&apos;s AI engine was built to handle exactly these edge cases.
              </p>
              <ul className="space-y-4">
                {[
                  'Auto-detects all Union Bank statement formats (savings, current, CC)',
                  'Handles Union Bank password protection (Customer ID based)',
                  'Resolves merged cells and split transaction rows',
                  'Extracts clean party names from Union Bank\'s verbose descriptions',
                  'Maps voucher types for direct Tally import',
                  'Auto-tags GST/IGST/CGST/SGST from transaction narrations',
                  '99.3% accuracy across all Union Bank statement variants',
                ].map((feat, i) => (
            ...
            <div className="relative">
              <div className="brutal-card p-8 bg-card relative z-10">
                ...
                <p className="text-muted-foreground font-medium mb-6">
                  Your Union Bank bank statement is processed in-memory and permanently deleted the moment your conversion is complete. We never store your financial data — ever.
                </p>
      ...
      <section className="py-24 border-b-2 border-shadow-color bg-card">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              Union Bank Statement <span className="text-primary bg-primary/10 px-2 border-2 border-primary inline-block mt-2 sm:mt-0">FAQ</span>
            </h2>
          </div>
          <div className="space-y-6">
            {[
              {
                q: "How to convert Union Bank bank statement PDF to Excel?",
                a: "Go to Parsify.in and upload your Union Bank statement PDF. The AI engine auto-detects the Union Bank format, parses all transactions (including merged cells and multi-page tables), and delivers a clean Excel file in under 5 seconds. Works with statements from NetBanking, mobile app, and branch-issued copies."
              },
              {
                q: "Does Parsify support password-protected Union Bank statements?",
                a: "Yes! Union Bank typically protects statements with your Customer ID or date of birth. Simply upload the PDF, enter the password when prompted, and Parsify will decrypt and parse it accurately. The password is used in-browser only and never stored."
              },
              {
                q: "Which Union Bank account types are supported?",
                a: "Parsify supports all Union Bank account types: Savings Account, Current Account, Credit Card statements, Fixed Deposit statements, Demat/Trading account statements, and NRE/NRO account statements. All formats are auto-detected."
              },
              {
                q: "Can I import Union Bank Excel output into Tally?",
                a: "Yes! Parsify auto-maps Union Bank transactions to Tally voucher types (Receipt, Payment, Contra), extracts clean party names from Union Bank's narration text, and formats dates uniformly — making the output directly importable into Tally Prime and Tally ERP 9."
              },
              {
                q: "Is the Union Bank statement converter free?",
                a: "You can convert 1 Union Bank statement daily completely free — no signup needed. Create a free account for 50 pages per month. Paid plans for CA firms start at ₹999/month for 40 statements."
              }
            ].map((faq, i) => (
      ...
      <section className="py-24 bg-primary text-primary-foreground border-b-2 border-shadow-color relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-8 leading-tight">
            Convert your Union Bank <span className="text-secondary bg-white px-2 border-4 border-shadow-color inline-block rotate-2 brutal-shadow mt-2 md:mt-0">statement now</span>
          </h2>
          <p className="text-xl font-bold mb-12 max-w-2xl mx-auto">
            Join 2,400+ CA firms using Parsify to automate Union Bank bank statement reconciliation.
          </p>
