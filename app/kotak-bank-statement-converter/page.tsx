...
const kotakFaqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can convert 1 Kotak statement per day completely free without signing up. Create a free account for 2 statements daily. Paid plans start at ₹999/month for 40 statements."
      }
    }
  ]
};
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "You can convert 1 Kotak statement daily completely free — no signup needed. Create a free account for 2 statements per day. Paid plans for CA firms start at ₹999/month for 40 statements."
              }
            ].map((faq, i) => (
