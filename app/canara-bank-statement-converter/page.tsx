...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can convert 1 Canara Bank statement per day completely free without signing up. Create a free account for 50 free pages monthly. Paid plans start at ₹999/month for 40 statements."
      }
    }
  ]
};
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "You can convert 1 Canara Bank statement daily completely free — no signup needed. Create a free account for 50 pages per month. Paid plans for CA firms start at ₹999/month for 40 statements."
              }
            ].map((faq, i) => (
