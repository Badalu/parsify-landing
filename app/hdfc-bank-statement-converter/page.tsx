...
export const metadata: Metadata = {
  title: 'HDFC Bank Statement to Excel Converter — PDF to Excel/CSV Free | Parsify',
  description:
    'Convert HDFC bank statement PDF to Excel or CSV instantly. Supports all HDFC statement formats — savings, current, credit card, fixed deposit. Auto GST tagging, Tally-ready output. Free for Indian CAs.',
  alternates: {
    canonical: 'https://parsify.in/hdfc-bank-statement-converter',
  },
  openGraph: {
    title: 'HDFC Bank Statement to Excel Converter — Free | Parsify',
    description: 'Convert HDFC bank statement PDF to clean Excel/CSV in seconds. Auto-detects all HDFC formats. Used by 2,400+ CA firms across India.',
    url: 'https://parsify.in/hdfc-bank-statement-converter',
...
const hdfcFaqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How to convert HDFC bank statement PDF to Excel?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Go to Parsify.in, upload your HDFC bank statement PDF, and download a clean Excel file in seconds. Parsify auto-detects all HDFC statement formats including savings, current, and credit card statements."
      }
    },
    {
      "@type": "Question",
      "name": "Does Parsify support HDFC NetBanking downloaded statements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Parsify supports all HDFC statement formats — statements downloaded from HDFC NetBanking, HDFC mobile app, and even scanned/physical copies. Both portrait and landscape layouts are handled automatically."
      }
    },
    {
      "@type": "Question",
      "name": "Can I convert password-protected HDFC bank statements?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Just upload the PDF and enter the password when prompted. Parsify handles HDFC's standard password format (usually your customer ID or date of birth) and extracts all transactions accurately."
      }
    },
    {
      "@type": "Question",
      "name": "Is the HDFC statement converter free?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can convert 1 HDFC statement per day completely free without signing up. Create a free account for 2 statements daily. Paid plans start at ₹999/month for 40 statements."
      }
    }
  ]
};
...
const HDFC_FORMATS = [
  { name: 'HDFC Savings Account', desc: 'Standard savings account statements from NetBanking or branch' },
  { name: 'HDFC Current Account', desc: 'Business current account statements with high transaction volumes' },
  { name: 'HDFC Credit Card', desc: 'Credit card statements with merchant details and reward points' },
  { name: 'HDFC Fixed Deposit', desc: 'FD statements with interest accrual and maturity details' },
  { name: 'HDFC Demat/Trading', desc: 'Demat account statements with stock transaction details' },
  { name: 'HDFC NRI Account', desc: 'NRE/NRO account statements with forex conversion details' },
];

export default function HdfcConverterPage() {
  return (
    <main className="bg-background min-h-screen text-foreground selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-6 sm:pt-10 lg:pt-16 pb-12 sm:pb-20 border-b-2 border-shadow-color overflow-hidden bg-grid-pattern">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground font-medium mb-10 max-w-lg leading-relaxed">
                Upload your HDFC bank statement PDF — savings, current, or credit card. Get a clean, structured Excel or CSV file in under 5 seconds. Auto GST tagging and Tally-ready output included.
              </p>
        ...
        {/* JSON-LD for HDFC FAQs */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(hdfcFaqSchema) }}
        />
      </section>
      ...
      <section className="border-b-2 border-shadow-color bg-card">
        <div className="max-w-7xl mx-auto flex flex-wrap lg:grid lg:grid-cols-4 divide-y-2 lg:divide-y-0 lg:divide-x-2 divide-shadow-color">
          {[
            ...
            { num: '99.3%', label: 'Accuracy on HDFC' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              All HDFC <span className="text-primary bg-primary/10 px-2 border-2 border-primary inline-block mt-2 sm:mt-0">Formats Supported</span>
            </h2>
            <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
              Parsify auto-detects every HDFC statement layout. No manual template selection needed — just upload and download.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {HDFC_FORMATS.map((format, i) => (
      ...
      <section className="py-24 border-b-2 border-shadow-color bg-card bg-grid-pattern">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              Convert HDFC Statement <span className="text-secondary inline-block mt-2 sm:mt-0">in 3 Steps</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                num: '01',
                title: 'Upload HDFC PDF',
                desc: 'Drag and drop your HDFC bank statement. Password-protected PDFs are handled automatically. Works with NetBanking, mobile app, and branch downloads.',
                icon: FileText,
              },
              {
                num: '02',
                title: 'AI Parses Everything',
                desc: 'Our engine reads every transaction row, resolves HDFC\'s merged cells and multi-page formatting, auto-tags GST, extracts party names, and categorizes transactions.',
                icon: Zap,
              },
              {
                num: '03',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-6 leading-tight">
                Why CAs Choose Parsify for <span className="bg-secondary text-white px-2 border-2 border-shadow-color inline-block rotate-1 mt-2 lg:mt-0">HDFC Statements</span>
              </h2>
              <p className="text-lg text-muted-foreground font-medium mb-10">
                HDFC Bank statements are notoriously difficult to parse — merged header rows, inconsistent date formats, multi-page transaction tables that break mid-row. Parsify&apos;s AI engine was built to handle exactly these edge cases.
              </p>
              <ul className="space-y-4">
                {[
                  'Auto-detects all HDFC statement formats (savings, current, CC)',
                  'Handles HDFC password protection (Customer ID based)',
                  'Resolves merged cells and split transaction rows',
                  'Extracts clean party names from HDFC\'s verbose descriptions',
                  'Maps voucher types for direct Tally import',
                  'Auto-tags GST/IGST/CGST/SGST from transaction narrations',
                  '99.3% accuracy across all HDFC statement variants',
                ].map((feat, i) => (
            ...
            <div className="relative">
              <div className="brutal-card p-8 bg-card relative z-10">
                ...
                <p className="text-muted-foreground font-medium mb-6">
                  Your HDFC bank statement is processed in-memory and permanently deleted the moment your conversion is complete. We never store your financial data — ever.
                </p>
      ...
      <section className="py-24 border-b-2 border-shadow-color bg-card">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-shadow-color font-sans mb-4 leading-tight">
              HDFC Statement <span className="text-primary bg-primary/10 px-2 border-2 border-primary inline-block mt-2 sm:mt-0">FAQ</span>
            </h2>
          </div>
          <div className="space-y-6">
            {[
              {
                q: "How to convert HDFC bank statement PDF to Excel?",
                a: "Go to Parsify.in and upload your HDFC statement PDF. The AI engine auto-detects the HDFC format, parses all transactions (including merged cells and multi-page tables), and delivers a clean Excel file in under 5 seconds. Works with statements from NetBanking, mobile app, and branch-issued copies."
              },
              {
                q: "Does Parsify support password-protected HDFC statements?",
                a: "Yes! HDFC typically protects statements with your Customer ID or date of birth. Simply upload the PDF, enter the password when prompted, and Parsify will decrypt and parse it accurately. The password is used in-browser only and never stored."
              },
              {
                q: "Which HDFC account types are supported?",
                a: "Parsify supports all HDFC account types: Savings Account, Current Account, Credit Card statements, Fixed Deposit statements, Demat/Trading account statements, and NRE/NRO account statements. All formats are auto-detected."
              },
              {
                q: "Can I import HDFC Excel output into Tally?",
                a: "Yes! Parsify auto-maps HDFC transactions to Tally voucher types (Receipt, Payment, Contra), extracts clean party names from HDFC's narration text, and formats dates uniformly — making the output directly importable into Tally Prime and Tally ERP 9."
              },
              {
                q: "Is the HDFC statement converter free?",
                a: "You can convert 1 HDFC statement daily completely free — no signup needed. Create a free account for 2 statements per day. Paid plans for CA firms start at ₹999/month for 40 statements."
              }
            ].map((faq, i) => (
      ...
      <section className="py-24 bg-primary text-primary-foreground border-b-2 border-shadow-color relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight mb-8 leading-tight">
            Convert your HDFC <span className="text-secondary bg-white px-2 border-4 border-shadow-color inline-block rotate-2 brutal-shadow mt-2 md:mt-0">statement now</span>
          </h2>
          <p className="text-xl font-bold mb-12 max-w-2xl mx-auto">
            Join 2,400+ CA firms using Parsify to automate HDFC bank statement reconciliation.
          </p>
