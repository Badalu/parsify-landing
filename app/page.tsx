...
<!-- Background Grid -->
    ...
    <section id="pricing" class="pricing scroll-reveal">
        ...
        <div class="pricing-cards">
            ...
            <div class="price-card">
                ...
                <div class="price-strike">solo CA ke liye</div>
                <ul class="features-list">
                    <li>✓ ~40 statements/month</li>
                    <li>✓ 500 total pages</li>
                    <li>✓ Standard AI parsing</li>
                    <li>✓ Email support</li>
                </ul>
                <a href="#start" class="btn-ghost btn-block">Get Starter</a>
            </div>
            ...
            <div class="price-card featured">
                ...
                <div class="price-strike">small firm</div>
                <ul class="features-list">
                    <li>✓ ~120 statements/month</li>
                    <li>✓ 1500 total pages</li>
                    <li>✓ Priority Gemini AI parsing</li>
                    <li>✓ Priority support</li>
                </ul>
                <a href="#start" class="btn-primary btn-block">Get Growth</a>
            </div>
            
            <!-- Pro Tier -->
            <div class="price-card">
                <div class="tier-name">Pro</div>
                <div class="price">₹3,400<span>/ month</span></div>
                <div class="price-strike">busy season ready</div>
                <ul class="features-list">
                    <li>✓ ~400 statements/month</li>
                    <li>✓ 5000 total pages</li>
                    <li>✓ API access + webhooks</li>
                    <li>✓ 24/7 Dedicated support</li>
                </ul>
                <a href="#contact" class="btn-ghost btn-block">Get Pro</a>
            </div>
        </div>
    ...
    <section class="faq scroll-reveal">
        ...
        <div class="faq-container">
            <div class="faq-item">
                <button class="faq-question">Bank statement PDF to Excel kaise convert karein?<span class="faq-icon">+</span></button>
                <div class="faq-answer">
                    <p>Parsify par login karein, apna bank statement PDF drag and drop karein, aur software automatically read karke perfect Excel (.xlsx) ya CSV sheet taiyar kar dega jise aap download kar sakte hain.</p>
                </div>
            </div>
            <div class="faq-item">
                <button class="faq-question">CA ke liye best bank statement analyzer tool kaunsa hai?<span class="faq-icon">+</span></button>
                <div class="faq-answer">
                    <p>CAs ke liye Parsify best bank statement analyzer tool hai kyunki ye HDFC, SBI, ICICI, Axis samet 200+ Indian banks ke statement formats support karta hai aur bad format multi-page tables ko perfectly clean Excel tables mein convert kar deta hai.</p>
                </div>
            </div>
            <div class="faq-item">
                <button class="faq-question">GST statement converter India mein kaunsa use karein?<span class="faq-icon">+</span></button>
                <div class="faq-answer">
                    <p>India mein GST data aur portal statement conversions ke liye Parsify ekdam reliable converter hai jo GST data files ko structured and audit-ready Excel formats mein extract karke reconcile karne mein madad karta hai.</p>
                </div>
            </div>
            <div class="faq-item">
                <button class="faq-question">Parsify free mein use kar sakte hain?<span class="faq-icon">+</span></button>
                <div class="faq-answer">
                    <p>Haan! Bina kisi credit card ke aap Parsify par sign up karke 50 pages free monthly convert kar sakte hain.</p>
                </div>
            </div>
            <div class="faq-item">
                <button class="faq-question">Kitne pages free mein process hote hain?<span class="faq-icon">+</span></button>
                <div class="faq-answer">
                    <p>Parsify par registration ke baad har mahine 50 pages free mein process hote hain, jo har month ki 1st date (1 tarik) ko automatically reset ho jaate hain.</p>
                </div>
            </div>
        </div>
    </section>
