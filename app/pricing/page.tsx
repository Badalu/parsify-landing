  ...
  const plans = [
    {
      ...
      features: ["~40 statements/month (500 pages)", "Standard AI parsing", "Excel, CSV & Tally XML Export", "All 200+ banks supported", "Email support"],
    ...
    },
    {
      ...
      features: ["~400 statements/month (5000 pages)", "Direct Tally XML Export", "API Access & Webhooks", "Custom integrations", "24/7 Dedicated Support"],
      missing: [],
      cta: "Get Started",
      popular: false,
    },
